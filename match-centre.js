...
function matchTab(tab){if(!['feedback','tactics','changes','lineup','stats','players','events'].includes(tab))return;matchDesk.tab=tab;matchDesk.notice='';matchPause();render();matchFocus('match-tab-'+tab);}
