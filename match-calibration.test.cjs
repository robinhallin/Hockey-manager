...
console.log('Production engine sample',JSON.stringify({periods,per60,savePct:+(savePct*100).toFixed(2)}));
...
console.log('PASS: calibrated production Match Engine 4 envelope',JSON.stringify({per60,savePct:+(savePct*100).toFixed(2)}));