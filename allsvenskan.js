...
function haResearchPanel(p){
 ...
 const uncertain=(r.model?.observations?Object.keys(labels).filter(key=>!Object.hasOwn(r.model.observations,key)):[]).map(key=>labels[key]);
