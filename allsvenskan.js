...
function haAge(birth,asOf=PLAYER_EVIDENCE_MODEL.asOf){const d=new Date(birth+'T00:00:00Z'),now=new Date(asOf+'T00:00:00Z');return now.getUTCFullYear()-d.getUTCFullYear()-(now.getUTCMonth()<d.getUTCMonth()||(now.getUTCMonth()===d.getUTCMonth()&&now.getUTCDate()<d.getUTCDate())?1:0);}
