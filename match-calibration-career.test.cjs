...
// Isolate calibration from separately tested tactical/task multipliers.
r('globalThis.originalFitFactor=tacticalFitFactor;globalThis.originalTaskFactor=playerTaskFactor;tacticalFitFactor=()=>1;playerTaskFactor=()=>1');
...
assert.equal(r("e.attribute(a,'passing')"),r('matchCalibrationAttribute(17.4)'));
r('readinessAttribute=originalReadiness;tacticalFitFactor=originalFitFactor;playerTaskFactor=originalTaskFactor;save()');
