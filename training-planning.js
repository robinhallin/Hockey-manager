...
function trainingEffectiveLoad(p){return p.trainingReturn?.club===managerClub()&&p.trainingReturn.date<=state.calendar?.date?'normal':p.trainingLoad||'normal';}
function trainingSessionEffect(p,session,load=trainingEffectiveLoad(p)){
