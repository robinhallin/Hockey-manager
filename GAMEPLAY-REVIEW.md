...
| Matcher | Egna matcher använder samma produktionsmotor för visningslägena; skottförsök skiljs från skott på mål. | Match-, statistik-, byte-, medicin- och sparningstester ingår i helhetskontrollen. Bakgrundsmatcher använder fortfarande en snabbare separat simulering och ska inte beskrivas som identiska med 2D-motorn. |
