"use strict";
// Club names follow the published 2026/27 opening round; new rosters/resources are fictional.
...
function leagueRoster(name,strength){
...
function ensureLeagues(){
 ...
 for(const [name,,,strength] of ALLSVENSKAN_CLUBS){
  if(!state.clubRosters[name])state.clubRosters[name]=leagueRoster(name,strength);
