...
function tacticalReviewRecord(before,label,coachDecision=null){
 const m=state.live,after=tacticalReviewPlan();
 if(!m?.analysis||m.finished||(!coachDecision&&JSON.stringify(before)===JSON.stringify(after)))return;
...
function tacticalReviewView(rows,finished=false){
 ...
 const labels={tactic:'Mentalitet',attackStyle:'Spelidé',forecheck:'Forecheck',tempo:'Tempo',physicality:'Fysisk nivå',shiftLength:'Byteslängd',shotChoice:'Avslutsval',lineUsage:'Kedjeanvändning',matchupLine:'Vår matchningskedja',matchupTarget:'Motståndarkedja'};
 const values={none:'Fri rotation','0':'Kedja 1','1':'Kedja 2','2':'Kedja 3','3':'Kedja 4',attack:'Offensiv',defense:'Defensiv',balanced:'Balanserad',passive:'Avvaktande',aggressive:'Aggressiv',low:'Lågt',normal:'Normalt',high:'Högt',safe:'Disciplinerat',hard:'Hårt',short:'30 sek',long:'60 sek',patient:'Sök bättre läge',shoot:'Skjut oftare',rollFour:'Rulla fyra',topHeavy:'Toppa laget',...HOCKEY_STYLES};
