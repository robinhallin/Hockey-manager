...
function playerHistoryView(id){
 ...
 const events=(state.playerWorld?.events||[]).filter(e=>samePlayerId(e.id,id)),career=careerHistoryPlayer(findPlayerAnywhere(id)||{id,careerEvents:[]});
