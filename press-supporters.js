...
function pressAfterFixture(g,rows=[],reports=[],partial=false){
 ...
 for(const club of [g.home,g.away]){
  ...
  relationshipPublicOutcome(c,followup);
...
function pressResponseOptions(e,c){return [
 {id:'shield',label:'Ta ansvar och försvara laget',text:'”Jag tar ansvar för helheten. Vi löser det här tillsammans.” Lojala spelare och spelare med behov av trygghet kan få +1 i förtroende om de redan har minst 45; tidigast var fjärde tävlingsmatch.'},
...
function pressRespond(id,choice){
 ...
 if(['results','youth'].includes(choice)){
