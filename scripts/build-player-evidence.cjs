...
const players=[...rosterPlayers,...freeAgents];
...
const generated={version:'se-2026-09-07-evidence2',asOf:'2026-09-07',checked:'2026-09-23',players:{}};
...
const coverage={asOf:generated.asOf,checked:generated.checked,players:players.length,
 ...
 matched,excluded,
 freeAgents:freeAgents.map(p=>({id:p.id,birth:p.birth,name:p.name,source:p.source,departure:p.departure,checked:'2026-09-23',status:'Existing start assumption retained. Public profile crosschecked; an absent new club does not prove no unannounced agreement exists.'})),
 limits:['Current roster pages do not prove all historical registrations. No post-start transfers backdated.', 'Original two-season statistics retained; new official data cover published goalie tables and skater top-25 leader lists only.', 'No skater time-on-ice, shift role, PP/PK usage or tracking measurements imported.', 'Academy teams remain explicitly fictional. Free-agent pool is four documented starting assumptions, not every available professional.']};
generated.coverage={rosterPlayers:rosterPlayers.length,freeAgents:freeAgents.length,officialPlayers:coverage.officialPlayers};
const artifacts={
