...
assert.deepEqual(s("JSON.stringify(StudioHockey.strengthState([{side:0,affectsStrength:true},{side:0,affectsStrength:true}],false))"),JSON.stringify([3,5]));
assert.deepEqual(s("JSON.stringify(StudioHockey.strengthState([{side:0,affectsStrength:true},{side:1,affectsStrength:true}],false))"),JSON.stringify([4,4]));
assert.deepEqual(s("JSON.stringify(StudioHockey.strengthState([{side:0,affectsStrength:true},{side:0,affectsStrength:true},{side:0,affectsStrength:true}],false))"),JSON.stringify([3,5]));
