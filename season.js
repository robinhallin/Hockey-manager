...
function launchSeason(){
 ...
 state.schedule=createSchedule(state.world.membership);leagueReset();state.round=1;state.selectedRound=1;state.live=null;state.lines=null;state.specialTeams=null;
