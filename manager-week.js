...
function managerWeekFocusView(){
 ...
 if(f){
  const definition=COACH_FOCUSES[f.key],complete=f.results.length>=(f.target||3),slot=complete?null:coachPlanSlot(f.key);
