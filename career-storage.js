...
const CAREER_PACK_FORMAT='hockey-manager-lzw16-v2';
...
function careerUnpack(value){
 const resettable=value?.format===CAREER_PACK_FORMAT;
 ...
 for(let i=0;i<value.data.length;i++){
  ...
  // Old saves can use 65535 as data. Only v2 reserves it to reset a full
