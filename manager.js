...
function managerCreateJobs(){
 ...
 for(const {name,rank} of chosen){
  ...
  const group=careerOffer(name,state.clubRosters).group,min=leagueOf(name)==='HA'?(group==='title'?20:5):group==='title'?50:group==='playoff'?25:5;
